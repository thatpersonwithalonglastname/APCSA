...
/**
 * program the users information to setup a password
 *
...
public class C6_1 {
    ...
    /**
     * checks if the required parameters are met with the password
     *
     * @param password the users password
     * @return true for false based on the users password
     */
