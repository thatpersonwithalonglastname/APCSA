...
/**
 * program the conversion of Dollors to Euros,pounds, and yen
 *
 * @author @author Isaiah Hajabolhassan
 *
 */
public class P6 {
    ...
    /**
     * it takes a certain percentage of the money depending on how much money
     * the user inputs
     *
     * @param dollars the amount of money the user inputs
     * @param exchangeRate the rate of exchange
     * @return the total amount you would get back if you exchanged it
     */
